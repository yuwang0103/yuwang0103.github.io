...
-----
<ul>
<li>[07] 🎉🎉🎉 Our collaborative research project has been awarded by the National Science Foundation IIS-III Core program (my role: lead PI). This project aims to develop a well-rounded graph retrieval-augmented generation framework, targeting society, security, and document understanding! Thanks a lot to the NSF and all collaborators for the support!
