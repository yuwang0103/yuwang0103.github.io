...
- **Data Quality-aware Graph Machine Learning**
  <br> **[SDM 2024]** SIAM International Conference on Data Mining
...
- **Personalization of Large Language Models: A Survey**
  <br> **[TMLR 2025]** Transactions on Machine Learning Research
...
- **Large Graph Generative Models**
  ...
  <br> **Yu Wang**, Ryan A. Rossi, Namyong Park, Huiyuan Chen, Nesreen K. Ahmed, Puja Trivedi, Franck Dernoncourt, Danai Koutra, Tyler Derr
  <br> [[Paper]](https://openreview.net/forum?id=c01YB8pF0s)[[Code]](https://github.com/yuwvandy/Large-Graph-Generative-Model)

- **Edge Classification: New Directions in Topological Imbalance**
  <br> **[WSDM 2025]** ACM International Conference on Web Search and Data Mining
  <br> **Yu Wang**\*, Xueqi Cheng\*, Yuying Zhao, Charu Aggarwal, Tyler Derr
  <br> [[Paper]](https://dl.acm.org/doi/10.1145/3701551.3703518)[[Code]](https://github.com/XueqiC/TopoEdge)

- **Empowering GraphRAG with Knowledge Filtering and Integration**
  <br> **[EMNLP 2025]** Empirical Methods in Natural Language Processing
  <br> Kai Guo, Harry Shomer, Shenglai Zeng, Haoyu Han, **Yu Wang**, Jiliang Tang
...
- **BTS: A Comprehensive Benchmark for Tie Strength Prediction**
  ...
  <br> Xueqi Cheng, Catherine Yang, Yuying Zhao, **Yu Wang**, Hamid Karimi, Tyler Derr
  <br> [[Paper]](https://dl.acm.org/doi/10.1145/3711896.3737441)[[Code]](https://github.com/XueqiC/Awesome-Tie-Strength-Prediction)
...
- **Knowledge Graph-Based Sequential Recommendation with Session-Adaptive Propagation**
  <br> **[WWW 2024]** In Proceedings of the ACM Web Conference
  <br> **Yu Wang**, Amin Javari, Janani Balaji, Walid Shalaby, Tyler Derr, Xiquan Cui
  <br> [[Paper]](https://dl.acm.org/doi/10.1145/3589335.3648324)

- **A Topological Perspective on Demystifying GNN-based Link Prediction Performance**
  <br> **[ICLR 2024]** International Conference on Learning Representation
  <br> **Yu Wang**, Tong Zhao, Yuying Zhao, Yunchao Liu, Xueqi Cheng, Neil Shah, Tyler Derr
  <br> [[Paper]](https://openreview.net/forum?id=apA6SSXx2e)[[Code]](https://github.com/YuWVandy/Topo_LP_GNN)
...
- **Can One Embedding Fit All? A Multi-interest Learning Paradigm Towards Improving User Interest Diversity Fairness**
  <br> **[WWW 2024]** In Proceedings of the ACM Web Conference
  <br> Yuying Zhao, Minghua Xu, Huiyuan Chen, Yuzhong Chen, Yiwei Cai, Rashidul Islam, **Yu Wang**, Tyler Derr
  <br> [[Paper]](https://dl.acm.org/doi/10.1145/3589334.3645662)

- **Fair Dating Recommendations for Sexually Fluid Users via Opposite Gender Interaction Ratio**
  <br> **[AAAI 2024]** The 38th AAAI Conference on Artificial Intelligence
  <br> Yuying Zhao, **Yu Wang**, Yi Zhang, Pamela Wisniswski, Charu Aggarwal, Tyler Derr
  <br> [[Paper]](https://arxiv.org/abs/2402.12541)[[Code]](https://github.com/YuyingZhao/)

- **A Survey on Privacy in Graph Neural Networks: Attacks, Preservation, and Applications**
  <br> **[TKDE 2024]** IEEE Transactions on Knowledge and Data Engineering
  <br> Yi Zhang, Yuying Zhao, Zhaoqing Li, Xueqi Cheng, **Yu Wang**, Olivera Kotevska, Philip S. Yu, Tyler Derr
  <br> [[Paper]](https://arxiv.org/abs/2308.16375)

- **Fairness-Aware Graph Neural Networks: A Survey**
  <br> **[TKDD 2024]** ACM Transactions on Knowledge Discovery from Data
  <br> April Chen, Ryan A. Rossi, Namyong Park, Puja Trivedi, **Yu Wang**, Tong Yu, Sungchul Kim, Franck Dernoncourt, Nesreen K. Ahmed
  <br> [[Paper]](https://dl.acm.org/doi/abs/10.1145/3649142)

- **Collaboration-aware Graph Convolutional Networks for Recommender Systems**
  <br> **[WWW 2023]** In Proceedings of the ACM Web Conference
  <br> **Yu Wang**, Yuying Zhao, Yi Zhang, Tyler Derr
  <br><span style="color:red">**Top-10 Most Influential Paper in WWW'23**</span>
  <br>[[Paper]](https://arxiv.org/abs/2207.06221)[[Code]](https://github.com/yuwang0103/CAGCN)

- **Fairness and Explainability: Bridging the Gap Towards Fair Model Explanations**
  <br> **[AAAI 2023]** The 37th AAAI Conference on Artificial Intelligence
  <br> Yuying Zhao, **Yu Wang**, Tyler Derr
  <br> [[Paper]](https://arxiv.org/abs/2212.03840)[[Code]](https://github.com/YuyingZhao/FairExplanations-CFA)[[Slides]](https://yuwang0103.github.io/files/slides/AAAI23_fair_explanation.pdf)[[Poster]](https://yuwang0103.github.io/files/poster/AAAI23_fair_explanation.pdf)
...
- **Interpretable Chirality-Aware Graph Neural Network for Quantitative Structure-Activity Relationship Modeling in Drug Discovery**
  <br> **[AAAI 2023]** The 37th AAAI Conference on Artificial Intelligence
  <br> Yunchao Liu, **Yu Wang**, Oanh Vu, Rocco Moretti, Bobby Bodenheimer, Jens Meiler, Tyler Derr
  <br> [[Paper]](https://www.biorxiv.org/content/10.1101/2022.08.24.505155v1.abstract)[[Code]](https://github.com/meilerlab/MolKGNN)[[Slides]](https://yuwang0103.github.io/files/slides/AAAI23_chirality.pdf)[[Poster]](https://yuwang0103.github.io/files/poster/AAAI23_chirality.pdf)

- **Fairness and Diversity in Recommender Systems: A Survey**
  <br> **[TIST 2023]** ACM Transactions on Intelligent Systems and Technology
  <br> Yuying Zhao, **Yu Wang**, Yunchao Liu, Xueqi Cheng, Charu Aggarwal, Tyler Derr
  <br> [[Paper]](https://arxiv.org/abs/2307.04644)[[Code]](https://github.com/YuyingZhao/Awesome-Fairness-and-Diversity-Papers-in-Recommender-Systems)

- **Imbalanced Graph Classification via GNNs on Graph of Graphs**
  <br> **[CIKM 2022]** In Proceedings of the 31st ACM International Conference on Information and Knowledge Management
  <br> **Yu Wang**, Yuying Zhao, Neil Shah, Tyler Derr
  <br><span style="color:red">**Top-10 Most Influential Paper in CIKM'22**</span>
  <br> [[Paper]](https://arxiv.org/abs/2112.00238)[[Code]](https://github.com/yuwang0103/g2gnn)[[Slides]](https://yuwang0103.github.io/files/slides/CIKM22_G2GNN.pdf)[[Poster]](https://yuwang0103.github.io/files/poster/CIKM22_G2G.pdf)

- **Improving Fairness in GNNs via Mitigating Sensitive Attribute Leakage**
  <br> **[KDD 2022]** Proceedings of the 28th ACM SIGKDD Conference on Knowledge Discovery & Data Mining
  <br> **Yu Wang**, Yuying Zhao, Yushun Dong, Huiyuan Chen, Jundong Li, Tyler Derr
  <br> [[Paper]](https://arxiv.org/abs/2206.03426)[[Code]](https://github.com/yuwang0103/fairvgnn)[[Slides]](https://yuwang0103.github.io/files/slides/KDD22_FairVGNN.pdf)[[Poster]](https://yuwang0103.github.io/files/poster/KDD22_fairvgnn.pdf)

- **Fair Graph Learning with Imbalanced and Biased Data**
  <br> **[WSDM 2022]** ACM International Conference on Web Search and Data Mining
  <br> **Yu Wang**
  <br> [[Paper]](https://dl.acm.org/doi/abs/10.1145/3488560.3502218)[[Slides]](https://yuwang0103.github.io/files/slides/WSDM22_DC_Fair_Bias.pdf)

- **On Structural Explanation of Bias in Graph Neural Networks**
  <br> **[KDD 2022]** Proceedings of the 28th ACM SIGKDD Conference on Knowledge Discovery & Data Mining
  <br> Yushun Dong, Song Wang, **Yu Wang**, Tyler Derr, Jundong Li
  <br> [[Paper]](https://dl.acm.org/doi/abs/10.1145/3534678.3539319)[[Code]](https://github.com/yushundong/REFEREE)

- **ChemicalX: A Deep Learning Library for Drug Pair Scoring**
  <br> **[KDD 2022]** Proceedings of the 28th ACM SIGKDD Conference on Knowledge Discovery and Data Mining
  <br> Benedek Rozemberczki, Charles Tapley Hoyt, Anna Gogleva, Piotr Grabowski, Klas Karis, Andrej Lamov, Andriy Nikolov, Sebastian Nilsson, Michael Ughetto, **Yu Wang**, Tyler Derr, Benjamin M Gyori
  <br> [[Paper]](https://arxiv.org/abs/2202.05240)[[Code]](https://github.com/AstraZeneca/chemicalx)[[Slides]](https://yuwang0103.github.io/files/slides/KDD22_ChemicalX.pdf)

- **Tree Decomposed Graph Neural Network**
  <br> **[CIKM 2021]** In Proceedings of the 30th ACM International Conference on Information and Knowledge Management
  <br> **Yu Wang**, Tyler Derr
  <br> [[Paper]](https://dl.acm.org/doi/abs/10.1145/3459637.3482487)[[Code]](https://github.com/yuwang0103/TDGNN)[[Slides]](https://yuwang0103.github.io/files/slides/CIKM21_TDGNN.pdf)[[Poster]](https://yuwang0103.github.io/files/poster/CIKM21_.pdf)
...
- **A Data-Integration Analysis on Road Emissions and Traffic Patterns**
  <br> Smoky Mountains Computational Sciences and Engineering Conference Springer 2020 
  <br> Ao Qu, **Yu Wang**, Yue Hu, Yanbing Wang, Hiba Baroud
  <br><span style="color:red">**Best Paper Award in 2020 Smoky Mountain Data Challenge Competition by ORNL**</span>
  <br> [[Paper]](https://link.springer.com/chapter/10.1007/978-3-030-63393-6_34)
...
- **Building Trust in Deep Learning-Powered Network Traffic Classification: A Traffic-Explainer Framework**
  <br> **[SDM-AI4TS 2026]** SIAM International Conference on Data Mining, AI for Time Series Workshop
  <br> Riya Ponraj, Ram Durairajan, **Yu Wang**

- **Unveiling Submarine Cable Paths: A Self-Supervised Contrastive Learning Approach**
  <br> **[IMC-SW 2025]** ACM Internet Measurement Conference Student Workshop
...
- **Data-quality Aware Graph Machine Learning**
  <br> **[SDM-DF 2024]** SIAM International Conference on Data Mining Doctoral Forum
  <br> **Yu Wang**
...
- **Degree-Related Bias in Link Prediction**
  <br> **[ICDMW 2022]** IEEE International Conference on Data Mining Workshops
  <br> **Yu Wang**, Tyler Derr

- **Overcoming Data Quality Issues of Graph Neural Networks**
  <br> **[SDM-DF 2022]** SIAM International Conference on Data Mining Doctoral Forum
  <br> **Yu Wang**
